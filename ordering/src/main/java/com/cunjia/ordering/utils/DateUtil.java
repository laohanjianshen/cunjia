...
public class DateUtil {
  ...
  /*  public static Long getCurrentReverseTime(){
     ...
     * @author 甘雨
     */
    public static Long getCurrentTimestampOfZero() {
        return LocalDateTime.now().withHour(0).withMinute(0).withSecond(0).atZone(ZoneOffset.systemDefault()).toEpochSecond() * 1000;
    }
    ...
    public static Long getCurrentTimestamp() {
        return LocalDateTime.now().atZone(ZoneOffset.systemDefault()).toEpochSecond() * 1000;
    }
     ...
     * @author 甘雨
     */
    public static Long getTomorrowTimestampOfZero() {
        return LocalDateTime.now().withHour(0).withMinute(0).withSecond(0).atZone(ZoneOffset.systemDefault()).plusDays(1).toEpochSecond() * 1000;
    }
