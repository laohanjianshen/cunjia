package com.cunjia.ordering.plugins.censor;
...
public class SensitivewordFilter {
    ...
    public static void main(String[] args) {
        ...
        String string = "草你妈操你妈日你妈太多的伤yuming感情怀也许只局限于饲养基地 荧幕中的情节，主人公尝试着去用某种方式渐渐的很潇洒地释自杀指南怀那些自己经历的伤感。"
        ...
        String msg = "日你妈卖批垃圾狗日的东西草你妈干死全家死光贱货人渣混蛋媚外和弦兼职限量yuming caonima";
        System.out.println("被检测字符串长度：" + string.length());
        String newStr = filter.replaceSensitiveWord(msg, 1, "*");
